...
class SourceOfChangeEventsGitTest {
	...
	@Test "loading events on file level"() {
		...
		def expectedChangeEvents = [
				new ChangeEvent(commitInfo, new FileChangeInfo("Theories.java", "MODIFICATION", "/src/org/junit/experimental/theories", "", 1, 1), EMPTY),
				new ChangeEvent(commitInfo, new FileChangeInfo("TheoryMethodRunner.java", "MOVED", "/src/org/junit/experimental/theories/internal", "", 1, 1), EMPTY),
				new ChangeEvent(commitInfo, new FileChangeInfo("JUnit4ClassRunner.java", "MODIFICATION", "/src/org/junit/internal/runners", "", 1, 1), EMPTY),
				new ChangeEvent(commitInfo, new FileChangeInfo("JUnit4MethodRunner.java", "NEW", "", "/src/org/junit/internal/runners", 1, 1), EMPTY),
				new ChangeEvent(commitInfo, new FileChangeInfo("TestMethod.java", "MODIFICATION", "/src/org/junit/internal/runners", "", 1, 1), EMPTY),
				new ChangeEvent(commitInfo, new FileChangeInfo("StubbedTheories.java", "MODIFICATION", "/src/org/junit/tests/experimental/theories/extendingwithstubs", "", 1, 1), EMPTY),
				new ChangeEvent(commitInfo, new FileChangeInfo("StubbedTheoryMethod.java", "MODIFICATION", "/src/org/junit/tests/experimental/theories/extendingwithstubs", "", 1, 1), EMPTY),
				new ChangeEvent(commitInfo, new FileChangeInfo("TestMethodInterfaceTest.java", "MODIFICATION", "/src/org/junit/tests/extension", "", 1, 1), EMPTY)
		]
